const roundToOneDecimalPoint = (x) => Number(x.toFixed(1))
...
const predict_y = (reps, weight, exerciseId, bodyweight, isMale) => {
  ...
  return({percentile: Math.max(0, Math.min(100, roundToOneDecimalPoint(115471.14623106 * x - 8.801363625876917))), oneRepMax: roundToOneDecimalPoint(one_rm)})
};
console.log(predict_y(10, 75, 1, 76, true))
