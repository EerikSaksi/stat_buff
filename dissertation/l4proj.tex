...
%6.0 What you hope to gain, 6.1 , 6.2 , 6.3, quantitative results, 6.4 qualitative results, 6.5 thematic analysis, 6.6 summary of evaluation
...
I created Stat Buff, which is a crossover between a mobile strength exercise tracker and a multiplayer RPG. People struggle to start exercising, and even those who manage to start have high drop-off rates. I wanted to create an app which would get users to start and maintain the habit. Users are given a virtual character, and they can join a team with other virtual characters. Teams are assigned a monster enemy which they are tasked with killing. Killing this monster will progress your entire team forward, and give you a new enemy to fight. There is a time limit set to defeat a particular monster. Users strengthen their characters through becoming stronger in real life, and deal damage to their team's common enemy through workout effort. As there is a time limit to defeat the monster, users are under time pressure to do so. My app doesn't reward exercise through a simple point system: effort is rewarded through granting users new characters who deal damage in animated battles with the team's enemy. This makes the app satisfying to use, and exercise feel like you're helping others and not just yourself. I evaluated my app with users ranging from complete beginners to advanced lifters to investigate whether my app increased motivation to exercise. Users did not train more frequently, but some reported increased training intensity and motivation. Users showed roughly the same interest in individualistic and collective goals.
...
\section{Aim}
%FIX What i can do is how motivating it was, whether they exercised more, whether people started exercising
