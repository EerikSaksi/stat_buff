...
The primary goal of my project will be to a mixture between a personal and collaborative tracker. This app should implement these features through an RPG model, and support strength exercise tracking. 
In my evaluations I will seek out whether creating more goal diversity prevented drop-offs as I catered to more users, or caused them through the additional confusion. 
...
\citet{social_comparison_theory} argues that people change behaviour based on how they are viewed by others. Users are motivated to exercise, as they know everyone will see them contribute to the team. There is also negative enforcement, as users don't want to be seen as slackers by other team by being in the bottom of the team's leaderboard.
...
\subsubsection{Database/server}: User data needs to be stored and persisted, and should be accessible by other users.
...
\section{Enhancing Collaboration With Research}
...
\subsection{Shared vs Personal Motivation}
