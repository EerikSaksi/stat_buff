...
const index: React.FC = () => (
  <View style={{  height: "100%", width: "100%", flex: 1, justifyContent: "center", alignItems: "center" }}>
    <View style={{ width: "100%", height: '20%',  backgroundColor: 'blue'}}>
      <AppleAuthenticationButton style={{ width: "70%", height: '100%' }} onPress={() => alert("wowa")} buttonType={AppleAuthenticationButtonType.SIGN_UP} buttonStyle={AppleAuthenticationButtonStyle.WHITE_OUTLINE} />
    </View>
    <View>
