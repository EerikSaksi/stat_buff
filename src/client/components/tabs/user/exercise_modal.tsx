...
import { Text, Switch, View, Modal, TextInput, StyleSheet, SafeAreaView, Platform } from "react-native";
...
const styles = StyleSheet.create({
  ...
  arrow: { color: "black", fontSize: 40, left: 0, position: "absolute", top:  Platform.OS == "ios" ? "12%" : "2%" },
  text: { marginRight: "2%" },
