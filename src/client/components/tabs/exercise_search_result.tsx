...
const CREATE_USER_EXERCISE = gql`mutation($exerciseSlug: String!, $username: String!, $repetitions: Int!, $percentage: Int!, $liftmass: Int!) {
...
const UPDATE_USER_EXERCISE = gql`mutation($exerciseSlug: String!, $username: String!, $repetitions: Int!, $percentage: Int!, $liftmass: Int!) {
...
const ExerciseSearchResult: React.FC<{exerciseSlug: string, username: string}> = ({exerciseSlug, username}) => {
  ...
  const {data: savedData, refetch} = useQuery(USER_EXERCISE, {
    ...
    onCompleted: (data) => {
      ...
      if (data.userExercise && data.userExercise.repetitions) {
        ...
        setLiftmass(data.userExercise.liftmass)
  ...
  const [createUserExercise] = useMutation(CREATE_USER_EXERCISE, {
    variables: {exerciseSlug, username, repetitions, percentage, liftmass},
    onCompleted: () => refetch()
  })
